 ...
 // volatile char* GITHUB_BIN_URL = "https://raw.githubusercontent.com/GodFather01d/SYS-OTA/main/SYS_26_10_2024.ino.bin";
  ...
  unsigned char JT_OK_Flag = 0,JT_HELP_Flag = 0;
  ...
  void setup()
  {
    ...
    { 
      ...
      if(signupOK)
      {
        ...
        Firebase.setInt(fbdo, "TRIGGERED_SYSTEMS/" + String(sys_id) , 0);
     ...
     if(Serial.available()) 
      {
        ...
        if (strcmp(inputCharArray, "JT_SYS_OFF") == 0) 
        {
          ...
          Firebase.setInt(fbdo, "SYSTEM/" + String(sys_id) + "/SIREN_ON", 0);
          Firebase.setInt(fbdo, "SYSTEM/" + String(sys_id) + "/HELP_FLAG", 0);
          Firebase.setInt(fbdo, "TRIGGERED_SYSTEMS/" + String(sys_id) , 0);
          JT_SYSOFF_Flag = 1;
        ...
        if (strcmp(inputCharArray, "JT_PANIC") == 0) 
        {
          ...
          Firebase.setInt(fbdo, "TRIGGERED_SYSTEMS/" + String(sys_id) , 1);
        ...
        if (strcmp(inputCharArray, "JT_HELP") == 0) 
        {
                timeClient.update();

          JT_HELP_Flag = 1;
          Firebase.setInt(fbdo, "SYSTEM/" + String(sys_id) + "/HELP_FLAG", 1);
          Firebase.setInt(fbdo, "SYSTEM/" + String(sys_id) + "/SIREN_ON", 1);
          Firebase.setInt(fbdo, "TRIGGERED_SYSTEMS/" + String(sys_id) , 1);
          String Panic_history_path = "Date_" + String(currentDay) +"_"  + String(currentMonth) + "_"+ String(currentYear) + "_Time_"+ String(time_hours) + "_" + String(time_mint);
          Firebase.setBool(fbdo, "SYSTEM/" + String(sys_id) + "/HELP_HISTORY/" + Panic_history_path , true);  
        }
